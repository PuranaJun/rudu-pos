...
/** Batches and their ledger. Read once, then ask the engine as often as needed. */
export async function loadStockSnapshot(db: RuduPosDB = defaultDb): Promise<StockSnapshot> {
